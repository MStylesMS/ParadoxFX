...
class MpvZoneManager {
    ...
    async _startMpvProcess() {
        ...
        const useWayland = process.env.XDG_SESSION_TYPE && process.env.XDG_SESSION_TYPE.toLowerCase() === 'wayland';
        const mpvArgs = [
            // IPC settings
            ...
            // Video output: prefer Wayland if available, else GPU/DRM
            ...(useWayland
                ? ['--vo=wayland', '--gpu-context=wayland']
