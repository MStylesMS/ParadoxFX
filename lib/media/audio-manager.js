...
class AudioManager {
    constructor(config) {
        ...
        // TEMP: Hardcoded for socat debugging as requested
        this.speechSocket = `/tmp/pfx-speech-audio_zone1-spy.sock`;
    ...
    async _processSpeechQueue() {
        ...
        while (this.speechQueue.length > 0) {
            ...
            try {
                ...
                this.logger.debug('Ducking background music...');
                await this.setBackgroundMusicVolume(speechItem.duckVolume);
                ...
                // Additional wait to ensure player becomes idle, confirming completion
                await this._monitorProperty(this.speechSocket, 'idle-active', true);
                ...
                this.logger.debug('Restoring background music volume...');
    ...
    _sendMpvCommand(socketPath, cmdObj) {
        return new Promise((resolve, reject) => {
            const client = net.createConnection(socketPath, () => {
                ...
                console.log(`[SOCKET SEND] to ${socketPath}: ${cmdString.trim()}`); // Force console logging
            ...
            client.on('data', (chunk) => {
                ...
                console.log(`[SOCKET RECV] from ${socketPath}: ${buffer}`); // Force console logging
