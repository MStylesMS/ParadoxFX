    ...
    async handleCommand(command) {
        ...
        try {
            switch (command.command) {
                ...
                // Video commands
                case 'playVideo':
                    await this._playVideo(command.file, command.volumeAdjust, command.channel);
                    break;
                case 'stopVideo':
                ...
                // Audio commands
                case 'playAudio':
                    await this._playAudio(command.file, command.volumeAdjust, command.channel);
                    break;
                case 'playBackgroundMusic':
                    await this._playBackgroundMusic(command.file, command.volume, command.loop);
                    break;
