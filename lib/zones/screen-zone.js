...
class ScreenZone extends BaseZone {
    ...
    getSupportedCommands() {
        return [
            ...
            'videoQueue',
            'playAudio', 'playBackground', 'stopBackground', 
    ...
    async _playVideo(command) {
        ...
        // Handle ducking parameter for video files - default to 30% if not specified
        const duckingLevel = ducking !== undefined ? ducking : (isVideo ? 30 : 0);
        let duckId = null;
