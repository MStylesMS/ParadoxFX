...
class AudioZone extends BaseZone {
    ...
    getSupportedCommands() {
        return [
            ...
            'playSpeech', 'pauseSpeech', 'resumeSpeech', 'stopSpeech', 'skipSpeech', 'clearSpeechQueue', 'speechQueue',
    ...
    async _speechQueue() { const queueStatus = this.audioManager.getSpeechQueueStatus(); this.publishMessage('info', { type: 'speech_queue', queue: queueStatus.queue, current: queueStatus.current, length: queueStatus.length, isProcessing: queueStatus.isProcessing }); }
