        ...
        try {
            switch (command.command) {
                case 'setImage':
                    ...
                    break;
                case 'playVideo':
                    await this._playVideo(command.file || command.video, command.channel);
                    break;
                case 'playAudio':
                    await this._playAudio(command.file || command.audio, command.channel);
                    break;
                case 'playAudioFx':
                    await this._playAudioFx(command.file || command.audio, command.channel);
                    break;
                case 'playBackgroundMusic':
                    await this._playBackgroundMusic(command.file || command.audio, command.volume);
                    break;
                case 'stopVideo':
