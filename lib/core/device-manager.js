...
class DeviceManager {
    ...
    _createDevice(deviceConfig) {
        switch (deviceConfig.type) {
            case 'screen':
                return new ScreenDevice(deviceConfig, this.mqttClient);

            case 'light':
                return new LightDevice(deviceConfig, this.mqttClient);

            case 'light_group':
                return new LightGroupDevice(deviceConfig, this.mqttClient);

            case 'relay':
                return new RelayDevice(deviceConfig, this.mqttClient);
